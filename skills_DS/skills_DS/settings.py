"""
Django settings for skills_DS project.
...
SECRET_KEY = 'django-insecure-gyco8s@9otqhn_l7dlgtm5v!0u5@@fl7g16hy#eqwev*=o6qhz'
...
WSGI_APPLICATION = 'skills_DS.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'xEpdu0-waqqux-repwuf'
